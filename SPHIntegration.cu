#include "DEM/kernel/cudaKernel/GPUConfig.h"
#include "SPHIntegration.h"
#include <__clang_cuda_builtin_vars.h>

__global__ void configDummyParticlesKernel(double3* normal,
double3* position,
...
cudaStream_t stream)
{
    ...
    {
        configDummyParticlesKernel <<<gridDim, blockDim, 0, stream>>> (WCSPHs.normal(), 
        WCSPHs.position(), 
        WCSPHs.density(), 
        WCSPHs.mass(), 
        WCSPHs.smoothLength(), 
